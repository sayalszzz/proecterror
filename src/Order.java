...
public class Order {
    ...
    // ОШИБКА РЕФАКТОРИНГА 7: customerName/customerPhone — группа несгруппированных данных.
    ...
    // ОШИБКА ОПТИМИЗАЦИИ 7: сумма пересчитывается целиком при каждом изменении корзины.
